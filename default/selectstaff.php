...
$sql = "SELECT *  FROM `ugpreference` WHERE year='$selectyear' AND semester='$selectsemeter' ";
                                                                ...
                                                                <div class="media-body row">
                                                                    ...
                                                                    <div>
                                                                        <div class="pull-right cover-btn">
                                                                            <button type="button" class="btn btn-primary m-r-10 m-b-5"><i class="icofont icofont-plus"></i> Appointment</button>
