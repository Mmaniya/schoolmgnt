...
$sql = "SELECT * FROM `students` WHERE id='$staffid'";
                                        ...
                                        <div class="col-sm-12">
                                            ...
                                            <div class="card">
                                                ...
                                                <div class="card-block">
                                                    ...
                                                    <form action="function/stu_updateprofile.php" method="post" enctype="multipart/form-data">
                                                    <input type="hidden" name="staffid" value="<?php echo $staffid; ?>">
                                                        ...
                                                        <div class="form-group row">
                                                            <label class="col-sm-2 col-form-label">Upload Student Profile</label>
                                                            <div class="col-sm-10">
